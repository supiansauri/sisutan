...
<head>
  ...
  <style>
    * {
    ...
    .filter-bar input[type="number"], .filter-bar input[type="text"] {
      padding: 5px;
      font-size: 10px;
    }
...
<body>
  ...
  <div class="main-content">
    <div class="title-view">
      <span class="beranda-title">
        <i class="fas fa-home"></i> Beranda
      </span>
    </div>

    <div class="welcome">
      Selamat datang nama user, anda berhasil login sebagai admin
    </div>
    ...
    <button class="down-button" style="margin-top: 10px;">DAFTAR SURAT KEPUTUSAN</button>
