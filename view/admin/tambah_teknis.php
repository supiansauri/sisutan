...
<head>
  ...
  <title>Tambah Data Teknis - BPS Kota Sukabumi</title>
      ...
      <form action="submit_form.php" method="POST">
        <div class="form-column">
          <div class="form-group">
            ...
            <input type="text" id="nama_teknis" name="nama_teknis" placeholder="Masukkan Nama Teknis" required>
          </div>

          <div class="form-group">
            <label for="kode_teknis">Kode Teknis</label>
            <input type="text" id="kode_teknis" name="kode_teknis" placeholder="Masukkan Kode Teknis" required>
          </div>
