...
<head>
  ...
  <title>Tambah Data Pegawai - BPS Kota Sukabumi</title>
...
<body>
  ...
  <div class="content">
    ...
    <div class="container">
      <form action="submit_pegawai.php" method="POST">
        <div class="form-column">
          <div class="form-group">
            <label for="nama_pegawai">Nama</label>
            <input type="text" id="nama_pegawai" name="nama_pegawai" placeholder="Masukkan Nama Pegawai" required>
          </div>
